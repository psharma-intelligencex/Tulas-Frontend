...
const RegistrationDriveForm = () => {
  ...
  const eventDetails = {
    ...
    eventHeading: "TULAS CSA Registration Drive 2026-27",
    eventText: `
      <p>
        <strong>"The best way to predict the future is to create it." - Peter Drucker</strong>
      </p>
      <p>
        The wait is over! Registrations for the TULAS Cloud Security Alliance (CSA) Student Chapter 
      ...
      <p>
        <strong>✨ Why Join TULAS-CSA?</strong>
      </p>
      <ul>
