      ...
      <div className={styles.fadedWrapper}>
        <div className={styles.partyWrapper}>
          <div className={styles.CSA}>
            <img src="/img/UPESlogo.avif" alt="UPES CSA Logo" width={4560} height={4425} loading="lazy" />
          ...
          <div className={styles.xImg}>
            <img src="/img/x.png" alt="Partnership symbol" width={185} height={186} loading="lazy" />
          </div>
